...
const products = [
    ...
    { id: 6, name: 'أقراط كريستال ناعمة', category: 'accessories', price: 25, oldPrice: 35, image: 'https://raw.githubusercontent.com/Uldy-U/crystal-store/main/images/crystal-earrings-006.jpg', badge: 'new', description: 'أقراط ناعمة من كريستال سواروفسكي الأصلي.' },
    { id: 7, name: 'قلادة ذهبية عيار 18', category: 'accessories', price: 85, oldPrice: 110, image: 'https://raw.githubusercontent.com/Uldy-U/crystal-store/main/images/crystal-pendant-007.jpg', badge: '', description: 'قلادة ذهبية عيار 18 بتصميم كلاسيكي فاخر.' },
    { id: 8, name: 'إكسسوارات شعر فاخرة', category: 'accessories', price: 15, oldPrice: 22, image: 'https://raw.githubusercontent.com/Uldy-U/crystal-store/main/images/crystal-hair-008.jpg', badge: '', description: 'مجموعة إكسسوارات شعر كريستالية للمناسبات الخاصة.' },
    { id: 9, name: 'نظارة شمسية ماركة', category: 'accessories', price: 50, oldPrice: 70, image: 'https://raw.githubusercontent.com/Uldy-U/crystal-store/main/images/crystal-sunglasses-009.jpg', badge: 'new', description: 'نظارة شمسية بإطار معدني فاخر وحماية UV400.' },
    { id: 10, name: 'محفظة جلد طبيعي', category: 'accessories', price: 40, oldPrice: 55, image: 'https://raw.githubusercontent.com/Uldy-U/crystal-store/main/images/crystal-wallet-010.jpg', badge: '', description: 'محفظة يدوية من الجلد الطبيعي الإيطالي الفاخر.' },

    { id: 11, name: 'عطر كريستال الذهبي', category: 'perfumes', price: 55, oldPrice: 75, image: 'https://raw.githubusercontent.com/Uldy-U/crystal-store/main/images/crystal-perfume-gold-011.jpg', badge: 'bestseller', description: 'عطر فاخر بمزيج من العود والمسك والعنبر.' },
    { id: 12, name: 'عطر المسك الأبيض', category: 'perfumes', price: 42, oldPrice: 55, image: 'https://raw.githubusercontent.com/Uldy-U/crystal-store/main/images/crystal-perfume-musk-012.jpg', badge: '', description: 'عطر ناعم بعبق المسك الأبيض النقي والياسمين.' },
    { id: 13, name: 'عطر العود الفاخر', category: 'perfumes', price: 75, oldPrice: 95, image: 'https://raw.githubusercontent.com/Uldy-U/crystal-store/main/images/crystal-perfume-oud-013.jpg', badge: 'new', description: 'عطر شرقي فاخر بخلاصة العود الكمبودي النادر.' },
    ...
    { id: 15, name: 'عطر ليلى العربية', category: 'perfumes', price: 60, oldPrice: 80, image: 'https://raw.githubusercontent.com/Uldy-U/crystal-store/main/images/crystal-perfume-layla-015.jpg', badge: 'bestseller', description: 'عطر عربي أصيل بمزيج من العود والتوت البري والفانيليا.' },
    { id: 16, name: 'عطر البحر الأبيض', category: 'perfumes', price: 38, oldPrice: 50, image: 'https://raw.githubusercontent.com/Uldy-U/crystal-store/main/images/crystal-perfume-ocean-016.jpg', badge: 'new', description: 'عطر بحري منعش بعبق الليمون والأخشاب البحرية.' },
    { id: 17, name: 'عطر المسك الأسود', category: 'perfumes', price: 50, oldPrice: 68, image: 'https://raw.githubusercontent.com/Uldy-U/crystal-store/main/images/crystal-perfume-black-017.jpg', badge: '', description: 'عطر جريء بمزيج المسك الأسود والتوابل الشرقية.' },
    { id: 18, name: 'عطر الياسمين النبيل', category: 'perfumes', price: 45, oldPrice: 58, image: 'https://raw.githubusercontent.com/Uldy-U/crystal-store/main/images/crystal-perfume-jasmine-018.jpg', badge: '', description: 'عطر زهري نبيل بعبق الياسمين الهندي والبرغموت.' },
    { id: 19, name: 'عطر الفانيليا الدافئ', category: 'perfumes', price: 35, oldPrice: 48, image: 'https://raw.githubusercontent.com/Uldy-U/crystal-store/main/images/crystal-perfume-vanilla-019.jpg', badge: 'new', description: 'عطر دافئ وحلو بمزيج الفانيليا المدغشقرية والكراميل.' },
    { id: 20, name: 'عطر الصحراء الذهبية', category: 'perfumes', price: 68, oldPrice: 88, image: 'https://raw.githubusercontent.com/Uldy-U/crystal-store/main/images/crystal-perfume-desert-020.jpg', badge: '', description: 'عطر صحراوي فاخر بخلاصة العود والصندل والتوابل.' }
];
...
function loadCartFromStorage() {
    try {
        const saved = JSON.parse(localStorage.getItem('crystalCart') || '[]');
...
function saveCartToStorage() {
    ...
    window.dispatchEvent(new CustomEvent('crystal-cart-updated', { detail: cart }));
}

function getProductById(productId) {
    const fromMain = products.find(p => p.id === productId);
    if (fromMain) return fromMain;
    if (window.extraProducts) {
        return window.extraProducts.find(p => p.id === productId);
    }
    return null;
}
...
window.addEventListener('storage', (event) => {
    if (event.key === 'crystalCart') {
        loadCartFromStorage();
        updateCartUI();
    }
});

window.addEventListener('crystal-cart-updated', () => {
    loadCartFromStorage();
    updateCartUI();
});
...
function addToCart(productId) {
    ...
    const existingItem = cart.find(item => item.id === productId && item.category === product.category);
